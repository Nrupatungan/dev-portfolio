        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
            ...
            <Card className="h-[320px] md:col-span-3 lg:col-span-2">
              ...
              <ToolboxItems items={toolboxItems} className="mt-6" itemsWrapperClassName="animate-move-right [animation-duration:15s] pl-6" />
            </Card>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
            <Card className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2">
              ...
              <div className="relative flex-1" ref={constraintRef}>
                {hobbies.map((hobby, idx) => (
                  <motion.div key={idx} className="inline-flex items-center gap-2 px-6 py-1.5 bg-gradient-to-r from-emerald-300 to-sky-400 rounded-full absolute" style={{
                    left: hobby.left,
                    top: hobby.top
                  }}
                  drag
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              <div className="size-20 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 after:content-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
